...
export default function Home() {
  ...
  const formComponents = [
    ...
    <AssessmentForm data={data} updateFieldHandler={updateFieldHandler} />,
  ...
  return (
    <>
      <Head>
        <title>Formulário UX - Home </title>
      ...
      <main>
        <div className="text-center pt-10 text-slate-100">
          <div>
            <h2 className="font-semibold text-3xl pb-2">Formulário UX</h2>
            <p className=" p-3">
              Com sua colaboração, vamos desenvolver o projeto X. Por favor,
              preencha o formulário abaixo e nos envie sua opinião.
            </p>
          </div>
